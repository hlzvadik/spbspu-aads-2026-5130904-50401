...
namespace goltsov
{
  namespace detail
  {
    ...
    public:
      ...
      NodeBST< Key, Value >* push(Key, Value);
      BSTIterator< Key, Value > get(const Key&);
      BSTConstIterator< Key, Value > get(const Key&) const;
      BSTIterator< Key, Value > getLast() noexcept;
      ...
      BSTIterator< Key, Value > rotateLeft(BSTConstIterator< Key, Value >);
      BSTIterator< Key, Value > rotateRight(BSTConstIterator< Key, Value >);
      BSTIterator< Key, Value > rotateLargeLeft(BSTConstIterator< Key, Value >);
      BSTIterator< Key, Value > rotateLargeRight(BSTConstIterator< Key, Value >);
      size_t height(BSTConstIterator< Key, Value >) const noexcept;
      size_t height() const noexcept;
      size_t blackHeight(BSTConstIterator< Key, Value >) const noexcept;
    ...
    template< class Key, class Value >
    NodeBST< Key, Value >* falLeft(NodeBST< Key, Value >*);
    template< class Key, class Value >
    NodeBST< Key, Value >* falRight(NodeBST< Key, Value >*);
  }
}

template< class Key, class Value >
goltsov::detail::NodeBST< Key, Value >* goltsov::detail::falLeft(NodeBST< Key, Value >* a)
{
  if (!a)
  {
    return nullptr;
...
template< class Key, class Value >
goltsov::detail::NodeBST< Key, Value >* goltsov::detail::falRight(NodeBST< Key, Value >* a)
{
  if (!a)
  {
    return nullptr;
...
template< class Key, class Value, class Compare >
goltsov::detail::BSTree< Key, Value, Compare >::BSTree():
  root_(nullptr),
  size_(0)
{}
template< class Key, class Value, class Compare >
...
template< class Key, class Value, class Compare >
goltsov::detail::BSTree< Key, Value, Compare >::BSTree(const BSTree< Key, Value, Compare >& other):
  root_(nullptr),
  size_(0)
{
...
template< class Key, class Value, class Compare >
goltsov::detail::BSTree< Key, Value, Compare >::BSTree(BSTree< Key, Value, Compare >&& other):
  root_(other.root_),
  size_(other.size_)
{
  other.root_ = nullptr;
...
template< class Key, class Value, class Compare >
goltsov::detail::BSTree< Key, Value, Compare >& goltsov::detail::BSTree< Key, Value, Compare >::operator=(
  BSTree< Key, Value, Compare >&& other)
{
  if (&other != this)
  {
    swap(other);
...
template< class Key, class Value, class Compare >
goltsov::detail::NodeBST< Key, Value >* goltsov::detail::BSTree< Key, Value, Compare >::push(Key k, Value v)
{
  Compare comparator;
  NodeBST< Key, Value >* current = root_;
...
template< class Key, class Value, class Compare >
goltsov::detail::BSTIterator< Key, Value > goltsov::detail::BSTree< Key, Value, Compare >::get(const Key& k)
{
  Compare comparator;
  NodeBST< Key, Value >* current = root_;
  while (current)
...
{
  return BSTIterator< Key, Value >{falRight(root_)};
}
template< class Key, class Value, class Compare >
goltsov::detail::BSTConstIterator< Key, Value > goltsov::detail::BSTree< Key, Value, Compare >::getLast() const noexcept
{
  return BSTConstIterator< Key, Value >{falRight(root_)};
}
template< class Key, class Value, class Compare >
std::tuple< goltsov::detail::NodeBST< Key, Value >*, Value, bool >
  goltsov::detail::BSTree< Key, Value, Compare >::drop(const Key& k)
{
  Compare comparator;
  NodeBST<Key, Value>* current = root_;
  while (current)
...
template< class Key, class Value, class Compare >
size_t goltsov::detail::BSTree< Key, Value, Compare >::size() const
{
  return size_;
}
template< class Key, class Value, class Compare >
goltsov::detail::BSTIterator< Key, Value > goltsov::detail::BSTree< Key, Value, Compare >::begin()
{
  return BSTIterator< Key, Value >(falLeft(root_));
}
template< class Key, class Value, class Compare >
goltsov::detail::BSTConstIterator< Key, Value > goltsov::detail::BSTree< Key, Value, Compare >::begin() const
{
  return BSTConstIterator< Key, Value >(falLeft(root_));
}
template< class Key, class Value, class Compare >
goltsov::detail::BSTIterator< Key, Value > goltsov::detail::BSTree< Key, Value, Compare >::end()
{
  return BSTIterator< Key, Value >(nullptr);
}
template< class Key, class Value, class Compare >
goltsov::detail::BSTConstIterator< Key, Value > goltsov::detail::BSTree< Key, Value, Compare >::end() const
{
  return BSTConstIterator< Key, Value >(nullptr);
}
template< class Key, class Value, class Compare >
goltsov::detail::BSTIterator< Key, Value > goltsov::detail::BSTree< Key, Value, Compare >::rotateLeft(
  BSTConstIterator< Key, Value > it)
{
  ...
  P->black_height_ =
    std::max(P->left_ ? P->left_->black_height_ : 0, P->right_ ? P->right_->black_height_ : 0) +
      (P->is_black_ ? 1 : 0);
  current->height_ =
    std::max(current->right_ ? current->right_->height_ : 0, current->left_ ? current->left_->height_ : 0) + 1;
  current->black_height_ =
    std::max(current->left_ ? current->left_->black_height_ : 0, current->right_ ? current->right_->black_height_ :
      0) + (current->is_black_ ? 1 : 0);
  if (current->parent_)
  {
    ...
    current->parent_->black_height_ = std::max(current->parent_->right_ ? current->parent_->right_->black_height_
      : 0, current->parent_->left_ ? current->parent_->left_->black_height_ : 0) + (current->parent_->is_black_ ? 1
      : 0);
  }
  return BSTIterator< Key, Value > (current->right_);
}
template< class Key, class Value, class Compare >
goltsov::detail::BSTIterator< Key, Value > goltsov::detail::BSTree< Key, Value, Compare >::rotateRight(
  BSTConstIterator< Key, Value > it)
{
  NodeBST< Key, Value >* current = const_cast< NodeBST< Key, Value >* >(it.ptr_);
  if (!current)
...
template< class Key, class Value, class Compare >
goltsov::detail::BSTIterator< Key, Value > goltsov::detail::BSTree< Key, Value, Compare >::rotateLargeLeft(
  BSTConstIterator< Key, Value > it)
{
  NodeBST< Key, Value >* current = const_cast< NodeBST< Key, Value >* >(it.ptr_);
...
template< class Key, class Value, class Compare >
goltsov::detail::BSTIterator< Key, Value > goltsov::detail::BSTree< Key, Value, Compare >::rotateLargeRight(
  BSTConstIterator< Key, Value > it)
{
  NodeBST< Key, Value >* current = const_cast< NodeBST< Key, Value >* >(it.ptr_);
  if (!current->parent_ || !current->parent_->parent_)
...
template< class Key, class Value, class Compare >
size_t goltsov::detail::BSTree< Key, Value, Compare >::height(BSTConstIterator< Key, Value > it) const noexcept
{
  if (!it.ptr_)
  {
    return 0;
...
template< class Key, class Value, class Compare >
size_t goltsov::detail::BSTree< Key, Value, Compare >::height() const noexcept
{
  if (!root_)
  {
    return 0;
...
template< class Key, class Value, class Compare >
size_t goltsov::detail::BSTree< Key, Value, Compare >::blackHeight(BSTConstIterator< Key, Value > it) const noexcept
{
  if (!it.ptr_)
  {
    return 0;
...
template< class Key, class Value, class Compare >
size_t goltsov::detail::BSTree< Key, Value, Compare >::blackHeight() const noexcept
{
  if (!root_)
  {
    return 0;
...
template< class Key, class Value >
goltsov::detail::BSTIterator< Key, Value >::BSTIterator():
  ptr_(nullptr)
{}
template< class Key, class Value >
goltsov::detail::BSTIterator< Key, Value >::BSTIterator(const BSTIterator< Key, Value >& other):
  ptr_(other.ptr_)
{}
template< class Key, class Value >
goltsov::detail::BSTIterator< Key, Value >::BSTIterator(BSTIterator< Key, Value >&& other):
  ptr_(other.ptr_)
{
  other.ptr_ = nullptr;
}
template< class Key, class Value >
goltsov::detail::BSTIterator< Key, Value > goltsov::detail::BSTIterator< Key, Value >::operator=(
...
template< class Key, class Value >
goltsov::detail::BSTIterator< Key, Value >::BSTIterator(NodeBST< Key, Value >* ptr):
  ptr_(ptr)
{}
template< class Key, class Value >
goltsov::detail::BSTIterator< Key, Value > goltsov::detail::BSTIterator< Key, Value >::next() const
{
...
template< class Key, class Value >
bool goltsov::detail::BSTIterator< Key, Value >::hasNext() const noexcept
{
  return ptr_;
}
template< class Key, class Value >
goltsov::detail::BSTIterator< Key, Value > goltsov::detail::BSTIterator< Key, Value >::prev() const
{
  NodeBST< Key, Value >* current = ptr_;
  if (current->left_)
  {
...
template< class Key, class Value >
bool goltsov::detail::BSTIterator< Key, Value >::hasPrev() const noexcept
{
  return prev().ptr_;
}
template< class Key, class Value >
...
template< class Key, class Value >
std::pair< Key, Value >& goltsov::detail::BSTIterator< Key, Value >::operator*() const
{
  return ptr_->data_;
}
template< class Key, class Value >
...
template< class Key, class Value >
goltsov::detail::BSTIterator< Key, Value >::operator goltsov::detail::BSTConstIterator< Key, Value >() const
{
  return BSTConstIterator< Key, Value > (ptr_);
}
template< class Key, class Value >
goltsov::detail::BSTConstIterator< Key, Value >::BSTConstIterator():
  ptr_(nullptr)
{}
template< class Key, class Value >
goltsov::detail::BSTConstIterator< Key, Value >::BSTConstIterator(const BSTConstIterator< Key, Value >& other):
  ptr_(other.ptr_)
{}
template< class Key, class Value >
goltsov::detail::BSTConstIterator< Key, Value >::BSTConstIterator(BSTConstIterator< Key, Value >&& other):
  ptr_(other.ptr_)
{
  other.ptr_ = nullptr;
}
template< class Key, class Value >
goltsov::detail::BSTConstIterator< Key, Value >& goltsov::detail::BSTConstIterator< Key, Value >::operator=(
  const BSTConstIterator< Key, Value >& other)
{
  ptr_ = other.ptr_;
  return (* this);
}
template< class Key, class Value >
goltsov::detail::BSTConstIterator< Key, Value >& goltsov::detail::BSTConstIterator< Key, Value >::operator=(
  BSTConstIterator< Key, Value >&& other)
{
  ptr_ = other.ptr_;
  other.ptr_ = nullptr;
  return (* this);
...
template< class Key, class Value >
goltsov::detail::BSTConstIterator< Key, Value >::BSTConstIterator(const NodeBST< Key, Value >* ptr)
{
  ptr_ = ptr;
}
template< class Key, class Value >
goltsov::detail::BSTConstIterator< Key, Value > goltsov::detail::BSTConstIterator< Key, Value >::next() const
{
...
template< class Key, class Value >
bool goltsov::detail::BSTConstIterator< Key, Value >::hasNext() const noexcept
{
  return ptr_;
}
template< class Key, class Value >
goltsov::detail::BSTConstIterator< Key, Value > goltsov::detail::BSTConstIterator< Key, Value >::prev() const
{
  NodeBST< Key, Value >* current = const_cast< NodeBST< Key, Value >* > (ptr_);
  if (current->left_)
  {
...
template< class Key, class Value >
bool goltsov::detail::BSTConstIterator< Key, Value >::hasPrev() const noexcept
{
  return prev().ptr_;
}
template< class Key, class Value >
...
template< class Key, class Value >
const std::pair< Key, Value >& goltsov::detail::BSTConstIterator< Key, Value >::operator*() const
{
  return ptr_->data_;
}
template< class Key, class Value >
...
template< class Key, class Value >
bool goltsov::detail::BSTIterator< Key, Value >::operator==(const BSTConstIterator< Key, Value >& other) const noexcept
{
  return ptr_ == other.ptr_;
}
template< class Key, class Value >
...
template< class Key, class Value >
bool goltsov::detail::BSTConstIterator< Key, Value >::operator==(const BSTIterator< Key, Value >& other) const noexcept
{
  return ptr_ == other.ptr_;
}
template< class Key, class Value >
...
template< class Key, class Value >
bool goltsov::detail::BSTConstIterator< Key, Value >::operator==(const BSTConstIterator< Key, Value >& other) const noexcept
{
  return ptr_ == other.ptr_;
}
template< class Key, class Value >
...
template< class Key, class Value >
goltsov::detail::NodeBST< Key, Value >* goltsov::detail::BSTIterator< Key, Value >::getPtr() const
{
  return ptr_;
}
template< class Key, class Value >
const goltsov::detail::NodeBST< Key, Value >* goltsov::detail::BSTConstIterator< Key, Value >::getPtr() const
{
  return ptr_;
}
...
{}
template< class Key, class Value, class Compare >
goltsov::RBTree< Key, Value, Compare >& goltsov::RBTree< Key, Value, Compare >::operator=(
  const RBTree< Key, Value, Compare >& other)
{
  tree_ = other.tree_;
  return (* this);
}
template< class Key, class Value, class Compare >
goltsov::RBTree< Key, Value, Compare >& goltsov::RBTree< Key, Value, Compare >::operator=(
  RBTree< Key, Value, Compare >&& other)
{
  tree_ = std::move(other.tree_);
  return (* this);
}
template< class Key, class Value, class Compare >
goltsov::RBTIterator< Key, Value > goltsov::RBTree< Key, Value, Compare >::push(Key k, Value v)
{
...
template< class Key, class Value, class Compare >
goltsov::RBTIterator< Key, Value > goltsov::RBTree< Key, Value, Compare >::get(const Key& k)
{
  return tree_.get(k);
}
template< class Key, class Value, class Compare >
goltsov::RBTConstIterator< Key, Value > goltsov::RBTree< Key, Value, Compare >::get(const Key& k) const
{
  return tree_.get(k);
}
template< class Key, class Value, class Compare >
...
template< class Key, class Value, class Compare >
Value goltsov::RBTree< Key, Value, Compare >::drop(const Key& k)
{
...
template< class Key, class Value, class Compare >
size_t goltsov::RBTree< Key, Value, Compare >::size() const
{
  return tree_.size();
}
template< class Key, class Value, class Compare >
...
template< class Key, class Value, class Compare >
void goltsov::RBTree< Key, Value, Compare >::makeBalanceAfterDrop(std::tuple< detail::NodeBST< Key, Value >*, Value, bool >
  dropedParent)
{
  ...
  {
    if (tree_.blackHeight(detail::BSTConstIterator< Key, Value > (P->left_)) < tree_.blackHeight(
      detail::BSTConstIterator< Key, Value > (P->right_)) && P->left_ && !P->left_->is_black_)
    {
      P->left_->is_black_ = true;
      P->left_->black_height_ += 1;
      P->height_ = std::max(P->left_ ? P->left_->height_ : 0, P->right_ ? P->right_->height_ : 0) + 1;
    }
    else if (tree_.blackHeight(detail::BSTConstIterator< Key, Value > (P->left_)) > tree_.blackHeight(
      detail::BSTConstIterator< Key, Value > (P->right_)) && P->right_ && !P->right_->is_black_)
    {
    ...
    {
      detail::NodeBST< Key, Value >* B = (tree_.blackHeight(P->left_) < tree_.blackHeight(P->right_)) ? P->right_
        : P->left_;
      if (B)
      {
        if (B->is_black_ && ((P->left_ == B && B->left_ && !B->left_->is_black_) || (P->right_ == B && B->right_
          && !B->right_->is_black_)))
        {
          if (P->left_ == B)
          {
            ...
            P->is_black_ = true;
            P->height_ = std::max(P->left_ ? P->left_->height_ : 0, P->right_ ? P->right_->height_ : 0) + 1;
            P->black_height_ = std::max(P->left_ ? P->left_->black_height_ : 0, P->right_ ? P->right_->black_height_
              : 0) + (P->is_black_ ? 1 : 0);
            B->height_ = std::max(B->left_ ? B->left_->height_ : 0, B->right_ ? B->right_->height_ : 0) + 1;
            B->black_height_ = std::max(B->left_ ? B->left_->black_height_ : 0, B->right_ ? B->right_->black_height_
              : 0) + (B->is_black_ ? 1 : 0);
          }
          else
          {
        ...
        else if (B->is_black_ && ((P->left_ == B && B->right_ && !B->right_->is_black_) || (P->right_ == B
          && B->left_ && !B->left_->is_black_)))
        {
          if (P->left_ == B)
          {
            ...
            B->black_height_ = std::max(B->left_ ? B->left_->black_height_ : 0, B->right_ ? B->right_->black_height_
              : 0) + (B->is_black_ ? 1 : 0);
            B->parent_->height_ = std::max(B->parent_->left_ ? B->parent_->left_->height_ : 0, B->parent_->right_ ?
              B->parent_->right_->height_ : 0) + 1;
            B->parent_->black_height_ = std::max(B->parent_->left_ ? B->parent_->left_->black_height_ : 0, B->parent_->right_ ?
              B->parent_->right_->black_height_ : 0) + (B->parent_->is_black_ ? 1 : 0);
          ...
          else
          {
            ...
            B->parent_->height_ = std::max(B->parent_->left_ ? B->parent_->left_->height_ : 0, B->parent_->right_ ?
              B->parent_->right_->height_ : 0) + 1;
            B->parent_->black_height_ = std::max(B->parent_->left_ ? B->parent_->left_->black_height_ : 0,
              B->parent_->right_ ? B->parent_->right_->black_height_ : 0) + (B->parent_->is_black_ ? 1 : 0);
            makeBalanceAfterDrop(dropedParent);
          }
        }
        else if (!P->is_black_ && B->is_black_ && (!B->left_ || B->left_->is_black_) && (!B->right_
          || B->right_->is_black_))
        {
          B->is_black_ = false;
          B->black_height_ -= 1;
        ...
        else if (P->is_black_ && B->is_black_ && (!B->left_ || B->left_->is_black_)
          && (!B->right_ || B->right_->is_black_))
        {
          B->is_black_ = false;
          B->black_height_ -= 1;
          P->black_height_ -= 1;
